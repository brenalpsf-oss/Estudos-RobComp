...
class ImageNode(Node): # Mude o nome da classe
    ...
    def __init__(self):
        ...
        #cvBridge é uma biblioteca que funciona como ponte entre OpenCV e a ROS
    ...
    def image_callback(self, msg):
        if self.running:
            #converte a imagem recebida para um objeto do tipo numpy.ndarray utilizando a função imgmsg_to_cv2
